...
// SOMETIMES, NATIVE JS METHODS, HAVE DIFFERENT SYNTAX
...
console.log("Diego loves coding");
...
console.log(`Diego loves coding - using backticks`);
let firstName = "Diego";

// How can I reference the variable 'name' below in my message?
//IN JS, we use a special constructor/connector Expression.
// ${}
console.log(`${firstName} loves coding  `);
console.log(`${firstName} loves Pizza  `);
console.log(`${firstName} loves Football  `);
